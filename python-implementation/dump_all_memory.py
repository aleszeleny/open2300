...
if 'python-implementation' in script_dir:
    # Running from python-implementation directory
    sys.path.insert(0, script_dir)
else:
    # Running from root, add python-implementation to path
    python_impl_dir = os.path.join(os.path.dirname(script_dir), 'python-implementation')
